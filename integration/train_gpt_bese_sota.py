...
# ---------------------------------------------------------------------------
# BESE tokenizer support (inline to keep single-file submission)
# ---------------------------------------------------------------------------
...
def _load_bese_tokenizer(tokenizer_path: str):
    """Load BESE tokenizer from JSON and return (vocab_size, lut_builder_fn)."""
    from bese_fast_bpe import FastBESEBPETokenizer
    tok = FastBESEBPETokenizer.load(tokenizer_path)
    return tok
...
def main() -> None:
    ...
    if _is_bese_tokenizer(args.tokenizer_path):
        ...
        if not args.tokenizer_path.endswith(".model"):
            raise ValueError(f"Expected .model or .json tokenizer file: {args.tokenizer_path}")
